...
function generateUnique3DigitCodes(count) {
  ...
  const numbers = Array.from({ length: 1e3 }, (_, index) => index);
  ...
  return numbers.slice(0, safeCount).map((n) => String(n).padStart(3, "0"));
}
...
function createFreshState(childCount = DEFAULT_CHILD_COUNT) {
...
function sanitizeState(raw) {
  ...
  if (codes.length !== childCount || codes.some((c) => typeof c !== "string" || !/^[0-9]{3}$/.test(c)) || hasDuplicates(codes)) {
    codes = generateUnique3DigitCodes(childCount);
    codesRegenerated = true;
  }
  const unlockedRaw = Array.isArray(raw.unlocked) ? raw.unlocked : [];
  const unlocked = codesRegenerated ? Array.from({ length: childCount }, () => false) : Array.from({ length: childCount }, (_, index) => {
    return Boolean(unlockedRaw[index]);
  });
  const unlockMode = raw.unlockMode === UNLOCK_MODES.hint ? UNLOCK_MODES.hint : UNLOCK_MODES.card;
  const finalHintText = typeof raw.finalHintText === "string" ? raw.finalHintText : "";
  const wrongHintType = raw.wrongHintType === WRONG_HINT_TYPES.image ? WRONG_HINT_TYPES.image : WRONG_HINT_TYPES.text;
  const wrongHintText = typeof raw.wrongHintText === "string" ? raw.wrongHintText : "";
  const wrongHintImageDataUrl = typeof raw.wrongHintImageDataUrl === "string" ? raw.wrongHintImageDataUrl : null;
  return {
    version: 1,
    childCount,
    codes,
...
function AdminPage() {
  ...
  const [childCountInput, setChildCountInput] = reactExports.useState(state.childCount);
  const [unlockModeInput, setUnlockModeInput] = reactExports.useState(state.unlockMode);
  const [finalHintTextInput, setFinalHintTextInput] = reactExports.useState(state.finalHintText);
  const unlockedCount = reactExports.useMemo(() => state.unlocked.filter(Boolean).length, [state.unlocked]);
  const hasUnlockedProgress = unlockedCount > 0;
  const childCount = reactExports.useMemo(() => clampChildCount(childCountInput), [childCountInput]);
  ...
  const finalHintTextChanged = unlockModeInput === UNLOCK_MODES.hint && finalHintTextInput !== state.finalHintText;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "adminTopRow", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "adminTopRowInner", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "panel", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "panelTitle", children: "管理員設定" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "row", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: "1 1 180px" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fieldLabel", children: "兒童人數（會重新產生全部密碼）" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fieldLabel", children: "全部解鎖成功後顯示" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "pill", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "radio",
      ...
      unlockModeInput === UNLOCK_MODES.hint ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: 10 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fieldLabel", children: "最終寶藏提示（文字）" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
            className: "textarea",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { height: 12 } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "row", style: { justifyContent: "flex-end" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "panel", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "panelTitle", children: "目前密碼（管理員用）" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "grid", gap: 10 }, children: state.codes.map((code, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "row", style: { justifyContent: "space-between" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pill", children: [
          "小朋友 ",
          index + 1
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pill", style: { fontSize: 20, letterSpacing: 3 }, children: code })
      ] }, index)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { height: 12 } }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fieldLabel", children: "提示" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 14, opacity: 0.8 }, children: "更改設定後按「套用」才會生效；若調整人數會重設密碼與進度。" })
    ] })
  ] });
}
...
function FlipCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      ...
      onClick: isLocked ? void 0 : onFlip,
      "aria-label": ariaLabel,
      "aria-disabled": isLocked,
      style,
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flipCardInner", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flipCardFace flipCardFront", children: front }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flipCardFace flipCardBack", children: back })
      ] })
    }
  );
}
function HintBox({ title, text }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hintBox", role: "status", "aria-live": "polite", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hintTitle", children: title }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hintText", children: text || "再試一次～" })
  ] });
}
function RewardCard({ embedded = false } = {}) {
  const imgSrc = `${"/treasure-code-quest/"}reward-card-art.png`;
  const inner = /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rewardTitle", children: "寶藏兌換卡" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rewardArtWrap", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { className: "rewardArt", src: imgSrc, alt: "兌換卡圖片" }) })
  ] });
  if (embedded) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rewardInner", "aria-label": "寶藏兌換卡", children: inner });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rewardCard", "aria-label": "寶藏兌換卡", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rewardInner", children: inner }) });
}
var module$1 = {};
...
function fireConfetti(options = {}) {
  ...
  const origins = options.origins || (options.origin ? [options.origin] : [
  ...
  function launch() {
    ...
    window.setTimeout(() => {
      api({
        ...
        origin: { x, y: 0.2 + Math.random() * 0.18 },
...
function PlayPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "grid", gap: 10 }, children: [
    !allUnlocked ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "panel", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { height: 12 } }),
        usedMessage && !allUnlocked ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pill", role: "status", style: { width: "100%", justifyContent: "center" }, children: usedMessage }) : null,
        showWrongHint && !allUnlocked ? /* @__PURE__ */ jsxRuntimeExports.jsx(HintBox, { title: "密碼不對喔！", text: "再試一次～仔細想想看！" }) : null
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "row", style: { justifyContent: "center" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pill", children: [
        "進度 ",
        unlockedCount,
        "/",
        state.childCount,
    ...
    allUnlocked ? showFinalCard ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      FlipCard,
      {
        ...
        front: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rewardInner", "aria-label": "寶箱", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rewardTitle", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "寶箱已解鎖！" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "14px", marginTop: 4 }, children: "點一下打開寶藏！" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rewardArtWrap", style: { padding: 8 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { className: "rewardArt rewardArtContain", src: unlockedChestSrc, alt: "寶箱" }) })
        ] }),
        back: state.unlockMode === UNLOCK_MODES.card ? /* @__PURE__ */ jsxRuntimeExports.jsx(RewardCard, { embedded: true }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rewardInner", "aria-label": "最終寶藏提示", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rewardTitle", children: "最終寶藏提示" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "rewardArtWrap",
              style: { padding: 12, alignContent: "start", fontSize: 18, lineHeight: 1.5 },
              children: state.finalHintText || "（尚未設定最終提示）"
            }
          )
        ] })
      }
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(HashRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "appShell", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "topBar", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "brand", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "brandTitle", children: "寶藏解鎖" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "brandSubtitle", children: "一起輸入密碼，打開寶箱！" })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "main", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Navigate, { to: "/play", replace: true }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/play", element: /* @__PURE__ */ jsxRuntimeExports.jsx(PlayPage, {}) }),
